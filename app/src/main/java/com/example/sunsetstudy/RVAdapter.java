...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.CardViewHolder> {
    ...
    public RVAdapter(Context ct, String projNames[], int counts[]){
        context = ct;
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        holder.myText1.setText(projectNames[position]);
        holder.myTextCount.setText(Integer.toString(questionCounts[position]));
